...
if __name__ == "__main__":
    ...
    parse.add_argument('--input_file_path', default="../datasets/test_car_person_1080P.mp4", type=str, help="Path or rtsp url to the video/image file.")#文件夹所在目录
    ...
    # 初始化解码器
    decoder = sail.Decoder(opt.input_file_path, opt.compressed_nv12, opt.device_id)

    # 初始化编码器,开始推流测试
    if is_image(opt.input_file_path):
