...
void STrack::re_activate(KalmanFilter &kalman_filter, STrack &new_track, int frame_id, bool new_id)
{
...
void STrack::update(KalmanFilter &kalman_filter, STrack &new_track, int frame_id)
{
	this->frame_id = frame_id;
	this->tracklet_len++;
