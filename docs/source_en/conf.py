...
# Automatic numbering of images and tables
numfig = True
...
latex_elements = {
    ...
    # Set the body font, title font (sans serif), and transcription content (equal width font), respectively
    'fontpkg': r'''
    \setmainfont{FandolSong}
    \setsansfont{FandolHei}
    \setmonofont{FandolFang}
    ''',
    # Set the section title style
    # \usepackage[Lenny]{fncychap}  Bjarne, Sonny, Lenny, Glenn, Conny, Rejne
    'fncychap': '\\usepackage[Sonny]{fncychap}',
    # Figures appear strictly at the text
    # 'figure_align': 'H',
    # Preamble style
    # Catalog style：tocloft
    # Each section starts from a new page：newcommand{\sectionbreak}{\clearpage}
    # Left alignment of text：\usepackage[document]{ragged2e}
    'preamble':r'''
    \usepackage{tocloft}
...
latex_documents = [
    (master_doc, project + '.tex', project + u' User Manual',
     author, 'manual'),
]
...
texinfo_documents = [
    (master_doc, project, project + u' Documentation',
     author, project, u'SOPHON-SAIL: SAIL(SOPHON Artificial Intelligent Library).',
     'Miscellaneous'),
]
